...
on_install() {
  ...
  busybox unzip -qq -o "$ZIPFILE" "files/fsv-$F_ARCH" -j -d "$F_TARGETDIR"
  mv "$F_TARGETDIR/fsv-$F_ARCH" "$F_TARGETDIR/fsv"
}
...
set_permissions() {
  ...
  # Custom permissions
  set_perm $MODPATH/system/bin/fsv 0 2000 0755 u:object_r:system_file:s0
}
